...
class guruTableViewController: UITableViewController {
    ...
    let kivaLoanURL = "http://localhost/DataGuruIDN/index.php/Api/getDataGuru"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.id.text = loans[indexPath.row].id
        cell.nama.text = loans[indexPath.row].nama
    ...
    func parseJsonData(data: Data) -> [Loan] {
        ...
        do{
            ...
            for jsonLoan in jsonLoans{
                ...
                let loan = Loan()
                loan.id = jsonLoan["id_guru"] as! String
                loan.nis = jsonLoan["nis_guru"] as! String
                loan.nama = jsonLoan["nama_guru"] as! String
                loan.dob = jsonLoan["tgl_lahir"] as! String
                loan.mapel = jsonLoan["mata_pelajaran"] as! String
                loan.age = jsonLoan["umur"] as! String
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        ...
        idselected = task.id
        nisselected = task.nis
        nameselected = task.nama
        dobselected = task.dob
        asalselected = task.asal
        mapelselected = task.mapel
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "PassData"{
            ...
            kirimData.passdob = dobselected
            kirimData.passasal = asalselected
            kirimData.passmapel = mapelselected
